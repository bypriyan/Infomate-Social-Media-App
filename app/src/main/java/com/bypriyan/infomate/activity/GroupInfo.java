...
import com.bypriyan.infomate.databinding.ActivityGroupInfoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addParticipantsGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GroupInfo.this, groupParticipents.class);
        ...
        reference.child(groupId).child(Constant.KEY_PARTICIPENTS).child(firebaseAuth.getUid()).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(GroupInfo.this, "Group left Successfully...", Toast.LENGTH_SHORT).show();
    ...
    private void deleteGroup() {
        ...
        reference.child(groupId).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(GroupInfo.this, "Group Deleted Successfully...", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(GroupInfo.this, MainActivity.class));
                        finish();
                    }
                }).addOnFailureListener(new OnFailureListener() {
               ...
               for(DataSnapshot ds : snapshot.getChildren() ){
                   ...
                   ref1.orderByChild(Constant.KEY_UID).equalTo(uid).addValueEventListener(new ValueEventListener() {
                       ...
                       public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                           ...
                           adapterParticipentAdd = new AdapterParticipentAdd(GroupInfo.this, usersList, ""+groupId,""+myGroupRole);
