...
import com.bypriyan.infomate.databinding.ActivityGroupEditBinding;
...
public class GroupEdit extends AppCompatActivity {
    ...
    private void setInfo() {
        ...
        binding.groupDescription.setText(groupDescriptions);
    ...
    private void uploadData() {
        ...
        reference.child(groupId).updateChildren(hashMap)
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                pd.dismiss();
                Toast.makeText(GroupEdit.this, "Failed!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void uploadImg() {
        ...
        uploadTask.addOnCompleteListener(GroupEdit.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
