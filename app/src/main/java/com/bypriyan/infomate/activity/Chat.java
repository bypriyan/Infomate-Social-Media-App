...
import com.bypriyan.infomate.Adapter.AdapterChat;
...
public class Chat extends AppCompatActivity {
        ...
        userQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()){
                    String onlineStatus = ""+ds.child(Constant.KEY_ONLINE_STAUS).getValue();
                    String typingStatus = ""+ds.child(Constant.KEY_TYPING_STAUS).getValue();
                                ...
                                ds.getRef().removeValue()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                Toast.makeText(Chat.this, "Unblocked user...", Toast.LENGTH_SHORT).show();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()){
                    ...
                    adapterChat = new AdapterChat(Chat.this, chatList,getIntent().getStringExtra(Constant.KEY_IMAGE));
    ...
    private void SendNotification(String hisUid, String name, String message) {
        ...
        DatabaseReference allTokens = FirebaseDatabase.getInstance().getReference(Constant.KEY_TOKENS);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()){
                    ...
                    Data data = new Data(myUid, name+ " : "+message, name, hisUid, R.drawable.logo);
    ...
    private void checkOnlineStatus(String status){
        ...
        HashMap<String , Object> hashMap = new HashMap<>();
        hashMap.put(Constant.KEY_ONLINE_STAUS,status);
    ...
    private void checkTypingStatus(String typing){
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference(Constant.KEY_USERS).child(myUid);
        HashMap<String , Object> hashMap = new HashMap<>();
        hashMap.put(Constant.KEY_TYPING_STAUS,typing);
        databaseReference.updateChildren(hashMap);
