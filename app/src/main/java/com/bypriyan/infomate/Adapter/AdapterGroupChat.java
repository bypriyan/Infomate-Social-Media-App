...
import com.bypriyan.infomate.activity.groupChat;
...
public class AdapterGroupChat extends RecyclerView.Adapter<AdapterGroupChat.MyHolder> {
    ...
    public AdapterGroupChat(Context context, List<ModelGroupChat> groupChatList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_groupcgat_list, parent, false);
    ...
    private void loadLastMessage(ModelGroupChat model, MyHolder holder) {
